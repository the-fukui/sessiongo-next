...
const inputsInfo = {
  ...
  UsersWhereInput: ["AND", "OR", "NOT", "id", "email", "name", "sessions"],
  UsersOrderByWithRelationInput: ["id", "email", "name", "sessions"],
  UsersWhereUniqueInput: ["id", "email"],
  UsersOrderByWithAggregationInput: ["id", "email", "name", "_count", "_avg", "_max", "_min", "_sum"],
  UsersScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "email", "name"],
  ...
  UsersCreateInput: ["email", "name", "sessions"],
  UsersUncheckedCreateInput: ["id", "email", "name", "sessions"],
  UsersUpdateInput: ["email", "name", "sessions"],
  UsersUncheckedUpdateInput: ["id", "email", "name", "sessions"],
  UsersCreateManyInput: ["id", "email", "name"],
  UsersUpdateManyMutationInput: ["email", "name"],
  UsersUncheckedUpdateManyInput: ["id", "email", "name"],
  ...
  UsersCountOrderByAggregateInput: ["id", "email", "name"],
  UsersAvgOrderByAggregateInput: ["id"],
  UsersMaxOrderByAggregateInput: ["id", "email", "name"],
  UsersMinOrderByAggregateInput: ["id", "email", "name"],
  ...
  UsersCreateWithoutSessionsInput: ["email", "name"],
  UsersUncheckedCreateWithoutSessionsInput: ["id", "email", "name"],
  ...
  UsersUpdateWithoutSessionsInput: ["email", "name"],
  UsersUncheckedUpdateWithoutSessionsInput: ["id", "email", "name"],
...
const outputsInfo = {
  ...
  UsersGroupBy: ["id", "email", "name", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  UsersCount: ["sessions"],
  UsersCountAggregate: ["id", "email", "name", "_all"],
  UsersAvgAggregate: ["id"],
  UsersSumAggregate: ["id"],
  UsersMinAggregate: ["id", "email", "name"],
  UsersMaxAggregate: ["id", "email", "name"],
